...
className="group flex h-42 w-full cursor-pointer flex-col items-start justify-between rounded-3xl border border-gray-200 bg-white p-5 text-left shadow-sm transition hover:shadow-md active:scale-[0.99]"
>
